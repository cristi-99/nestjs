...
let CountriesService = class CountriesService {
    ...
    async deleteCountry(countryToDelete, res) {
        ...
        try {
            ...
            if (!country)
                throw new common_1.HttpException(common_1.NotFoundException, common_1.HttpStatus.BAD_REQUEST);
            country.deleteOne();
            return await this.PopulationModel.deleteOne({ _id: country.detailsOfCountry });
        }
        catch (_a) {
            (err) => {
                throw new common_1.HttpException(common_1.BadRequestException, common_1.HttpStatus.BAD_REQUEST);
            };
        }
    }
    getPopulation(id) {
