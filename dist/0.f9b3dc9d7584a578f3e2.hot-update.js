...
let AuthService = class AuthService {
    ...
    async register(registrationData, role) {
        const hashedPassword = await bcrypt.hash(registrationData.password, 10);
        try {
            const createdUser = await this.userService.create(Object.assign(Object.assign({}, registrationData), { password: hashedPassword, role: role.role }));
